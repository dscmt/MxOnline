    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            if UserProfile.objects.filter(email=user_name):
                return render(request, "register.html", {"msg": u"用户已存在", "login_form": register_form})
            ...
            send_register_email(user_name, "register") # 发送激活链接
            return render(request, "login.html")
        else:
            return render(request, "register.html", {"msg": u"用户名或密码错误"})
